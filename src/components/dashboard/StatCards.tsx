    ...
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      ...
      <Card className="bg-gradient-to-br from-[#0a0a0a] to-[#0f0f0f] border border-emerald-500/20 p-5 md:p-6 flex flex-col gap-4 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white">1.2M+</h3>
      ...
      <Card className="bg-gradient-to-br from-[#0a0a0a] to-[#0f0f0f] border border-emerald-500/20 p-5 md:p-6 flex flex-col gap-4 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white">{profile?.current_streak || 0} <span className="text-lg md:text-2xl text-slate-400">Days</span></h3>
      ...
      <Card className="bg-gradient-to-br from-[#0a0a0a] to-[#0f0f0f] border border-emerald-500/20 p-5 md:p-6 flex flex-col gap-4 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white">{profile?.daily_goal_ayahs || 0} <span className="text-lg md:text-2xl text-slate-400">Ayahs</span></h3>
